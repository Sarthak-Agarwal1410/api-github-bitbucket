...
bitbucket_repo_url = 'https://bitbucket.org/username/repo'

gh = github3.login(token = 'YOUR_GITHUB_TOKEN')
bb = bitbucket_api.Client(auth=('username', 'PASSWORD'))

github_repo = gh.repository(owner='username', repository='repo')
